      ...
      <section class="c-sort-box">
        <section class="c-s-dl">
          <dl>
            ...
            <dd class="c-s-dl-li">
              <ul class="clearfix">
                <li class="current"><a  title="全部分类" href="${pageContext.request.contextPath}/course/getall?i=1">全部分类</a></li>
                
                	<li ><a  href="${pageContext.request.contextPath}/course/selectcourse?data=数学">数学类</a></li>
                
                	<li ><a href="${pageContext.request.contextPath}/course/selectcourse?data=文艺">文艺类</a></li>
                
                	<li ><a href="${pageContext.request.contextPath}/course/selectcourse?data=计算机">计算机类</a></li>
                
                	<li ><a title="技能爱好" href="${pageContext.request.contextPath}/course/selectcourse?data=心理">心理/医学</a></li>
                
                	<li ><a  href="${pageContext.request.contextPath}/course/selectcourse?data=近代">历史学</a></li>
                
                	<li ><a  href="${pageContext.request.contextPath}/course/selectcourse?data=政治">政治学</a></li>
                
                	<li ><a  href="${pageContext.request.contextPath}/course/selectcourse?data=理">理学</a></li>
                
                	<li ><a  href="${pageContext.request.contextPath}/course/selectcourse?data=工">工学</a></li>
              </ul>
        ...
        <div class="mt40">
	          ...
	          <article class="comm-course-list">
	           ...
	           <c:forEach items="${courses}" var="courses">
	              <li>
	                <div class="cc-l-wrap">
	                  <section class="course-img"><a href="${pageContext.request.contextPath}/course/coursexq?id=${courses.id}">
	                  <img src="${courses.img }" class="img-responsive" alt="开学了"></a>
	                    <div class="cc-mask"> <a href="${pageContext.request.contextPath}/course/coursexq?id=${courses.id}" title="" class="comm-btn c-btn-1">开始学习</a> </div>
	                  </section>
	                  <h3 class="hLh30 txtOf mt10"> <a href="${pageContext.request.contextPath}/course/coursexq?id=${courses.id}" title="开学了" class="course-title fsize18 c-333">${courses.name }</a> </h3>
...
<script type="text/javascript" src="js/page.js"></script>
	...
	<div class="paging"> 
		<a href="${pageContext.request.contextPath}/course/getall?i=1" title="">首</a>
			...
			<a id="backpage" href="${pageContext.request.contextPath}/course/getall?i=${j-1>0?j-1:1}" title="">&lt;</a>
		<a id="backpage" href="${pageContext.request.contextPath}/course/getall?i=${pagenum+1>1?1:1}" title="">1</a>
		<a id="backpage" href="${pageContext.request.contextPath}/course/getall?i=${pagenum+1>2?2:pagenum+1}" title="">2</a>
		<a id="backpage" href="${pageContext.request.contextPath}/course/getall?i=${pagenum+1>3?3:pagenum+1}" title="">3</a>
		<a id="backpage" href="${pageContext.request.contextPath}/course/getall?i=${pagenum+1>4?4:pagenum+1}" title="">4</a>
		<a id="backpage" href="${pageContext.request.contextPath}/course/getall?i=${pagenum+1>5?5:pagenum+1}" title="">5</a>
			<a id="nextpage" href="${pageContext.request.contextPath}/course/getall?i=${j+1<pagenum+1?j+1:pagenum+1}" title="">&gt;</a>
		
		<a href="${pageContext.request.contextPath}/course/getall?i=${pagenum+1 }" title="">末</a>
		<div class="clear"></div>
	</div>
...
<link href="css/mw_320_768.css" rel="stylesheet" type="text/css" media="screen and (min-width: 320px) and (max-width: 768px)">
  ...
  <footer id="footer">
	...
	&nbsp;</p>
<p style="text-align: center;">
	<span style="font-size: 16px;">版权所有：湖北第二师范学院17计科一班</span></p>
    </section>
  </footer>
  <footer id="footer2">
    <ul>
