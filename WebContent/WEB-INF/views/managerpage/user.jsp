...
<body>
	<div id="pageAll">
		<div class="pageTop">
			<div class="page">
				<img src="${pageContext.request.contextPath}/js/img/coin02.png" /><span><a href="#">首页</a>&nbsp;-&nbsp;-</span>&nbsp;管理员管理
			</div>
		</div>
					...
					<table border="1" cellspacing="0" cellpadding="0">
						...
						<tr height="40px">
							...
							<td><a href="useradd.html"><img class="operation"
									src="${pageContext.request.contextPath}/js/img/update.png"></a> <img class="operation delban"
								src="${pageContext.request.contextPath}/js/img/delete.png"></td>
						</tr>
					</table>
	...
	<div class="banDel">
		<div class="delete">
			<div class="close">
				<a><img src="${pageContext.request.contextPath}/js/img/shanchu.png" /></a>
			</div>
