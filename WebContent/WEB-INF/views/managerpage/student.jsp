...
<tr>
<th width="100"> 学号 <span class="f_cB">*</span></th>
<td><div class="txtbox floatL" style="width:100px;"><input name="" type="text" size="5" value=""  required="required"></div></td>
</tr>
<tr>
...
<div class="selectbox" style="width:230px;">
<dl class="select" >
<input type="file" name="imgFile"></dl></div><!-- /selectbox --></td>
</tr>
<tr>
