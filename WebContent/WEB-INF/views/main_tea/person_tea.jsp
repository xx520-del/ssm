		...
		<div class="h-r-nsl">
			...
			<div id="headright">
	                    <div class="headimg">
               		    ...
               		    <div class="headname">欢迎${teacher.name }老师</div>
               		          <div id="exit" style="">
	                    <ul>
...
<div class="content clearfix" style="min-height: 386px;">
                    ...
                    <div class="main selected">
                        ...
                        <div class="classtext">
                            <form action="" class="form">
                                <div class="line">
                                    <span class="linetext">工　号: &nbsp; &nbsp; ${teacher.depid }</span>
                                </div>
                                <div class="line">
                                    <span class="linetext">姓　名: &nbsp; &nbsp; ${teacher.name }</span>
                                </div>
                                <div class="line">
                                    <span class="linetext">性　别:
                                   &nbsp; &nbsp;${teacher.sex>0?'男':'女' }</span>
                                </div>
                                <div class="line">
                                    ...
                                    <textarea id="stuintro">${teacher.tip}</textarea>
                                </div>
                    ...
                    <div class="main">
                        ...
                        <div class="classtext">
                            <form action="${pageContext.request.contextPath}/student/add" class="form">
                                <div class="line">
                                    <span class="linetext">账　　号:</span>
                                    <input type="text" value="${user.username }" name="name" id="name" class="inputname" readonly="readonly">
                                </div>
                                <div class="line">
                                    <span class="linetext">工   号:</span>
                                    <input type="text" name="id" value="${user.id }" class="inputname" readonly="readonly">
                                </div>
        ...
        文件： <input type="file" onchange="imgPreview(this)" name="imgFile"> <br>
                        ...
                        <div class="classtext">
                            <form action="" class="form">
                                <div class="line">
                                    ...
                                    <input type="password" name="ypassword" id="oldpassword" value="${user.password }" class="inputname">
                                </div>
                                <div class="line">
