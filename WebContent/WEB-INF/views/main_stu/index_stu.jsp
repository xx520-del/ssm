  ...
  <div id="aCoursesList"> 
    ...
    <div class="bg-fa of">
      <section class="container">
        ...
        <header class="comm-title"> <span class="fr mt5"><a href="${pageContext.request.contextPath}/course/getall_stu?i=1"  class="c-master" >全部课程</a></span>
        ...
        <article class="comm-course-list">
          <ul class="of" id="weinituijian">
            ...
            <li>
              <div class="cc-l-wrap">
                <section class="course-img"><a href="${pageContext.request.contextPath}/course/coursexq_stu?id=${hotcourses.id}"><img src="${hotcourses.img }" class="img-responsive" alt="${hotcourses.name}"></a>
                  <div class="cc-mask"> <a href="${pageContext.request.contextPath}/course/coursexq_stu?id=${hotcourses.id}" title="开始学习" class="comm-btn c-btn-1">开始学习</a> </div>
                </section>
                <h3 class="hLh30 txtOf mt10"> <a href="${pageContext.request.contextPath}/course/coursexq_stu?id=${hotcourses.id}" title="${hotcourses.name }" class="course-title fsize18 c-333">${hotcourses.name}</a></h3>
    ...
    <div class="bg-fa of">
      ...
      <section class="container">
        ...
        <header class="comm-title"> <span class="fr mt5"><a href="${pageContext.request.contextPath}/course/getall?i=1"  class="c-master" >全部课程</a></span>
          <h2 class="fl tac"> <span class="c-333">已选课程</span> </h2>
        </header>
        <article class="comm-course-list">
          <ul class="of" id="weinituijian">
			
           <c:forEach items="${yxcourses}" var="yxcourses">
            <li>
              <div class="cc-l-wrap">
                <section class="course-img"><a href="${pageContext.request.contextPath}/course/coursexq_stu?id=${yxcourses.id}"><img src="${yxcourses.img }" class="img-responsive" alt="${yxcourses.name}"></a>
                  <div class="cc-mask"> <a href="${pageContext.request.contextPath}/course/coursexq_stu?id=${yxcourses.id}" title="开始学习" class="comm-btn c-btn-1">开始学习</a> </div>
                </section>
                <h3 class="hLh30 txtOf mt10"> <a href="${pageContext.request.contextPath}/course/coursexq_stu?id=${yxcourses.id}" title="${yxcourses.name }" class="course-title fsize18 c-333">${yxcourses.name}</a></h3>
                <section class="hLh20 of">
    ...
    <div>
      <section class="container">
        ...
        <div>
            ...
            <ul class="of">
              ...
              <li>
                <section class="i-teach-wrap">
                  <div class="i-teach-pic"> <a href="${pageContext.request.contextPath}/teacher/getall_stu?i=1" title="唐江澎"> <img src="${hotteachers.iconurl }" alt="唐江澎"> </a> </div>
                  <div class="mt10 hLh30 txtOf tac"> <a href="${pageContext.request.contextPath}/teacher/getall_stu?i=1" title="唐江澎" class="fsize18 c-666">${hotteachers.name}</a> </div>
          ...
          <section class="tac pt20"> <a href="${pageContext.request.contextPath}/teacher/getall_stu?i=1" title="全部讲师" class="comm-btn c-btn-2">全部讲师</a> </section>
        </div>
      </section>
    </div>
    <!-- /网校名师 结束 --> 
