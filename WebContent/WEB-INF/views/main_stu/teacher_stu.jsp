            ...
            <ul class="of">
              ...
              <li>
                <section class="i-teach-wrap">
                  <div class="i-teach-pic"> <a href="${pageContext.request.contextPath}/course/selectcourse_stu?data=${teachers.name}" title="唐江澎"> <img src="${teachers.iconurl }" alt="${teachers.name }"> </a> </div>
                  <div class="mt10 hLh30 txtOf tac"> <a href="${pageContext.request.contextPath}/course/selectcourse_stu?data=${teachers.name}" title="唐江澎" class="fsize18 c-666">${teachers.name }</a> </div>
...
<script type="text/javascript" src="js/page.js"></script>
	...
	<div class="paging"> 
		...
		<a id="backpage" href="${pageContext.request.contextPath}/teacher/getall_stu?i=${j-1>0?j-1:1}" title="">&lt;</a>
		
		
		
			<a id="nextpage" href="${pageContext.request.contextPath}/teacher/getall_stu?i=${j+1>pagenum+1?pagenum+1:j+1}" title="">&gt;</a>
