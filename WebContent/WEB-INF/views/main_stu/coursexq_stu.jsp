...
function joinClick(){
	if(${user.username==null}){
		alert("您没有登录，请登录后学习！或登录已过期，请重新登录!");
...
<div id="aCoursesList" class="bg-fa of"> 
    ...
    <section class="container">
      <section class="path-wrap txtOf hLh30"> <a href="${pageContext.request.contextPath}/student/index_stu" title="" class="c-999 fsize14">首页</a> \ <a href="${pageContext.request.contextPath}/course/getall_stu?i=1" title="" class="c-999 fsize14">课程列表</a> \ <span class="c-333 fsize14">${courses.name}</span> </section>
      <div>
        ...
        <aside class="c-attr-wrap">
          <section class="ml30 mr15">
            ...
            <section class="c-attr-mt c-attr-undis cmt25">
              ...
              &nbsp;&nbsp; </span>
			  <span class="c-999 fsize14">已选该课人数：${courses.stu_much}&nbsp;&nbsp; 
              &nbsp;&nbsp; </span>
            </section>
            ...
            <section class="c-attr-mt">
            		...
            		<a  href="${pageContext.request.contextPath}/course/choose_stu?courseid=${courses.id}&id=${user.id}" title="加入学习" onclick="return joinClick()" class="comm-btn c-btn-3 bgb">加入学习</a> <span class="ml10"><tt class="c-green f-fM"></tt></span>
                ...
                <div class="commentHtml listDiv">
                  <div>
                    <h6 class="c-i-content c-infor-title"> <span>课程资料</span> </h6>
					  ...
					  <video src="${courses.video }" controls="controls" width="800" height="600">播放视频</video>
...
<footer class="courseInfo">
	<span onclick="join()" class="payBtn">加入学习</span>
...
<link href="../css/mw_320_768.css" rel="stylesheet" type="text/css" media="screen and (min-width: 320px) and (max-width: 768px)">
  ...
  <footer id="footer">
	...
	&nbsp;</p>
<p style="text-align: center;">
	<span style="font-size: 16px;">版权所有：湖北二师17计科1班</span></p>
    </section>
  </footer>
  <footer id="footer2">
    <ul>
